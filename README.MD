...
Já no diretório "factory", aplicando o método fábrica, temos a interface Logistica que é composta dois metodos validarFretePeso e validarFreteRegiao, que serão os metodos de todoas as classes derivadas de interface, porem cada uma com a sua lógica dentro do método. Temos o core.ts, o qual é a nossa fábrica que instância as nossas classes Carro.ts e Navio.ts, efetuam tais chamadas através do core.ts (fabrica).
